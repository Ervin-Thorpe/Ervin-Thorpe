...
- <b>⭐ 3-Part Comprehensive Project to Creating, Configuring and Deploying our own Ticketing System on Windows 10 in Azure: </b>
  - This project guides the creation, configuration and deployment of a ticketing system using an osTicket open-source on a Windows 10 Virtual Machine in Microsoft Azure, along with practical use cases for managing and resolving tickets within the system.
